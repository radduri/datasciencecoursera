...
Github repo for the Course: [Statistical Inference](https://github.com/radduri/datasciencecoursera/tree/master/06_Statistical_Inference/project)
</br>
Github repo for Rest of Specialization: [Data Science Coursera](https://github.com/radduri/datasciencecoursera)
...
##   VC  10 10 10
```
![](StatesticalInferenceProject2_files/figure-html/unnamed-chunk-3-1.png)<!-- -->

...
##                                                                            ##
##           Github Repo: https://github.com/radduri/datasciencecoursera      ##
##                                                                            ##
################# ~~~~~~~~~~~~~~~~~ ######## ~~~~~~~~~~~~~~~~~ #################
...
blogsFile <- file.info("./data/en_US/en_US.blogs.txt")$size / 1024.0 / 1024.0
newsFile <- file.info("./data/en_US/en_US.news.txt")$size / 1024.0 / 1024.0
twitterFile <- file.info("./data/en_US/en_US.twitter.txt")$size / 1024.0 / 1024.0
